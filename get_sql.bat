...
rem SET server=10.0.10.41
rem SET user=intranett
rem SET password=Megareader18
rem SET vpnpath="c:\program files\SonicWall\Global VPN Client\"
rem SET sqlpath=S:\Unified_SQL\
